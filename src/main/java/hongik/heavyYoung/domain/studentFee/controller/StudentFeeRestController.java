...
import hongik.heavyYoung.domain.studentFee.service.StudentFeeCommandService;
...
public class StudentFeeRestController {
    ...
    public ApiResponse<QrTokenResponse> generateStudentFeeQrToken() {
        return ApiResponse.onSuccess(studentFeeCommandService.generateStudentFeeQrToken());
    }
}
