...
public interface ApplicationRepository extends JpaRepository<Application, Long> {
    List<Application> findAllByApplicationTypeIn(Collection<ApplicationType> types);
...
""")
    Optional<Application> findActiveLockerApplications(@Param("now") LocalDateTime now, @Param("types") Collection<ApplicationType> types);
