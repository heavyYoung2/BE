package hongik.heavyYoun.domain.member.entity;

import hongik.heavyYoun.domain.member.enums.MemberRole;
import hongik.heavyYoun.domain.member.enums.MemberStatus;
import hongik.heavyYoun.domain.member.enums.StudentFeeStatus;
